...
public sealed class LeaderReviewAskUserGateTests
{
    ...
    public async Task Duplicate_and_recovery_are_idempotent()
    {
        ...
        Assert.Equal(LeaderReviewAskUserGateResultKind.Opened, (await fixture.Gate.RecoverAsync(fixture.Project.Id)).Single().Kind);
    ...
    private sealed class Fixture : IAsyncDisposable
    {
        ...
        public static async Task<Fixture> CreateAsync()
        {
            ...
            return new Fixture(context,project,taskId,revision,epochId,new LeaderReviewAskUserGate(context.Services.TaskRepository,new AssignmentReviewStateRepository(context.Services.Database),context.Services.LeaderAuthoritySettings,context.Services.ProjectLeaderRepository,context.Time));
        }
