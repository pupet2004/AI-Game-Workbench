...
public sealed class ProjectMemoryApi : IProjectMemoryApi
{
    ...
    public ProjectMemoryApi(DailySummaryRepository dailySummaries, ProjectMemoryPreferencesRepository preferences, LeaderSessionEpochRepository epochs, LeaderMessageRepository messages, ProjectLibraryProposalService libraryProposals, ProjectLibraryEvolutionRepository library, B1ProjectionService? b1Projections = null, Workbench.Storage.Tasks.TaskRepository? tasks = null, Workbench.Storage.Workers.TaskEventRepository? taskEvents = null) { _dailySummaries = dailySummaries; _preferences = preferences; _epochs = epochs; _messages = messages; _libraryProposals = libraryProposals; _b1Projections = b1Projections; _continuity = new ProjectContinuityMaterialService(this, epochs, messages, library, _b1Projections, tasks, taskEvents); }
