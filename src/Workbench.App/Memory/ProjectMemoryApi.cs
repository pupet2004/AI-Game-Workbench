...
public sealed class ProjectMemoryApi : IProjectMemoryApi
{
    ...
    public Task<IReadOnlyList<ProjectEvolutionCandidate>> ListEvolutionCandidatesAsync(Guid projectId, CancellationToken cancellationToken = default) => _candidates is null ? Task.FromResult<IReadOnlyList<ProjectEvolutionCandidate>>([]) : _candidates.ListActiveAsync(projectId, cancellationToken: cancellationToken);
    public Task<IReadOnlyList<ProjectEvolutionCandidate>> ListEvolutionCandidateHistoryAsync(Guid projectId, CancellationToken cancellationToken = default) => _candidates is null ? Task.FromResult<IReadOnlyList<ProjectEvolutionCandidate>>([]) : _candidates.ListAsync(projectId, cancellationToken: cancellationToken);
