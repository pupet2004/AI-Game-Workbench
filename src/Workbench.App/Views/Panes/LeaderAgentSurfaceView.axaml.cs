...
public partial class LeaderAgentSurfaceView : UserControl
{
    ...
    private const string Html = """
        ...
        <style>
        :root{color-scheme:dark;font-family:Segoe UI,system-ui,sans-serif}*{box-sizing:border-box}html,body{width:100%;height:100%;min-height:0}body{margin:0;background:#000;color:#fff;display:flex;flex-direction:column;overflow:hidden}#meta{flex:0 0 auto;padding:10px 14px;border-bottom:1px solid #333;background:#000;color:#fff;font-size:12px}#transcript{flex:1 1 auto;min-height:0;overflow:auto;padding:18px 14px;background:#000;user-select:text;scrollbar-width:thin;scrollbar-color:#999 transparent}#transcript::-webkit-scrollbar{width:8px;background:transparent}#transcript::-webkit-scrollbar-track{background:transparent}#transcript::-webkit-scrollbar-thumb{background:#999;border:2px solid transparent;border-radius:5px;background-clip:padding-box}#transcript::-webkit-scrollbar-button{display:none}.message{max-width:82ch;margin:0 0 14px;padding:12px 0;color:#fff;white-space:pre-wrap;line-height:1.5}.message.user{margin-left:auto;border:0;border-radius:16px;background:#252525;padding:10px 16px;max-width:78ch}.message.assistant{border:0;background:transparent;padding:8px 0;max-width:90ch}.message.error{border:1px solid #b84a4a;border-radius:7px;background:#321414;padding:12px 14px}.label{display:block;margin-bottom:5px;color:#888;font-size:11px;text-transform:uppercase}.message.user .label{color:#bdbdbd}.message.assistant .label{color:#666}.message.assistant h1,.message.assistant h2,.message.assistant h3{margin:10px 0 6px}.message.assistant code{padding:2px 5px;border-radius:4px;background:#181818;color:#e7e7e7}.codeBlock{position:relative;margin:10px 0;padding:12px;border:1px solid #333;border-radius:7px;background:#101010}.codeBlock pre{margin:0;overflow:auto}.copyCode{position:absolute;right:8px;top:8px}.approval{flex:0 0 auto;border:1px solid #b07c32;background:#2a1f08;padding:12px 14px;margin:0 14px 12px;border-radius:7px}.approval button,button{border:1px solid #666;color:#fff;background:#202020;border-radius:6px;padding:7px 11px;cursor:pointer;margin:3px}.approval button:hover,button:hover{background:#333}.activity{margin:8px 0;color:#a9a9a9}.activity summary{cursor:pointer;list-style:none}.activityMark{display:inline-block;width:20px;color:#bdbdbd}.activity pre{margin:6px 0 0 20px;padding:8px;max-height:180px;overflow:auto;background:#111;color:#aaa}.composer{flex:0 0 auto;display:grid;grid-template-columns:1fr;gap:8px;padding:8px 14px 0;background:#000}.composer.dragging{outline:1px dashed #888;outline-offset:-4px}#attachments{display:flex;gap:6px;flex-wrap:wrap}.attachment{display:inline-flex;max-width:240px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;padding:5px 9px;border-radius:12px;background:#252525;color:#ddd;font-size:12px}.composer textarea{width:100%;min-height:58px;resize:vertical;padding:9px;border:1px solid #666;border-radius:6px;background:#000;color:#fff}.composerBar{display:flex;gap:8px;align-items:center}.composerBar button{width:34px;height:30px;padding:0;font-size:18px}.composerBar #action{margin-left:auto}.composerBar #mode{color:#888;font-size:11px}.composerBar button:disabled{opacity:.4;cursor:default}input[type=file]{max-width:180px;color:#fff;font-size:11px}#tools{flex:0 0 auto;display:flex;gap:6px;align-items:center;min-height:0;padding:8px 14px 2px;background:#000}#menuItems{display:flex;gap:4px}#menuItems[hidden]{display:none}#status{color:#fff;font-size:11px;margin-left:auto}
        .question{border:1px solid #555;background:#111;padding:12px 14px;margin:0 14px 12px;border-radius:7px}.question button{border:1px solid #666;color:#fff;background:#202020;border-radius:6px;padding:7px 11px;cursor:pointer;margin:3px}.changedFiles{margin:12px 0;border:1px solid #333;border-radius:7px;background:#0d0d0d;padding:10px}.changedFiles summary{cursor:pointer;color:#ddd}.changedFile{display:flex;justify-content:space-between;gap:12px;padding:5px 0;border-top:1px solid #222;font-size:12px}.changedFile button{margin:0;padding:3px 7px;font-size:11px}.diff{margin:8px 0;padding:10px;background:#050505;color:#bbb;white-space:pre;overflow:auto;max-height:280px;font:12px Consolas,monospace}
        </style></head><body>
