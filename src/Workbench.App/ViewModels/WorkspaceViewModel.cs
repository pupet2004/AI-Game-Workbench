...
public partial class WorkspaceViewModel : ViewModelBase, IAsyncDisposable
{
    ...
    public WorkspaceViewModel(
        ...
        ProjectLibraryEvolutionRepository? projectLibraryEvolutionRepository = null,
         ...
         Func<Task>? openProjectHistory = null,
         ...
         ConfirmedWorkerDraftLaunchService? confirmedWorkerDraftLaunch = null)
    {
        ...
        OpenProjectHistory = openProjectHistory ?? (() => Task.CompletedTask);
    ...
    internal Func<Task> OpenProjectHistory { get; }
    ...
    [RelayCommand]
    private Task OpenProjectHistoryPage() => OpenProjectHistory();
