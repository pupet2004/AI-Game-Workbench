...
public enum ContinuityMaterialKind { DailySummary, BrainHandoff, RecentConversation, LegacyFormal, LegacyLearned, LibraryOverview, LibraryTimelineNode }
...
public sealed record ResolvedContinuityMaterial(ContinuityMaterialKind Kind, string Reference, string Label, string Content, int Utf8Bytes);
